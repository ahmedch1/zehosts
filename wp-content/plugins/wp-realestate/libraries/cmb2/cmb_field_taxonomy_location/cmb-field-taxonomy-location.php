...
class WP_RealEstate_CMB2_Field_Taxonomy_Location {
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'wpre-taxonomy-location-script', $asset_path . '/js/script.js', array( 'cmb2-scripts', 'wre-select2', 'jquery-ui-sortable' ), self::VERSION );
		...
		wp_enqueue_style( 'wpre-taxonomy-location-style', $asset_path . '/css/style.css', array( 'wre-select2' ), self::VERSION );
	}
